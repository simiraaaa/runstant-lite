...
riot.tag('header', '<nav class="blue-grey darken-3"> <div class="nav-wrapper"><a href="/about" class="brand-logo"><img src="/images/runstant.png"><span>Run</span><span class="lighter">stant </span><span>Lite</span></a><a data-activates="nav-mobile" href="" class="button-collapse"><i class="material-icons">menu</i></a> <ul class="right hide-on-small-and-down"> <li data-tooltip="play" class="tooltipped"><a id="btn-play" href="" onclick="{opts.onplay}"><i class="material-icons">play_arrow</i></a></li> <li data-tooltip="fork" class="tooltipped"><a id="btn-play" href="" onclick="{fork}"><i class="material-icons">call_split</i></a></li> <li data-tooltip="share" class="tooltipped"><a id="btn-share" href="#" onclick="runstant.shareModal.open(); return false;"><i class="material-icons">share</i></a></li> <li data-tooltip="setting" class="tooltipped"><a id="btn-setting" href="#" onclick="runstant.detailModal.open(); return false;"><i class="material-icons">settings</i></a></li> </ul> <ul id="nav-mobile" class="side-nav"> <li><a href="" onclick="{play}"><i class="left material-icons">play_arrow</i>Play</a></li> <li><a href="" onclick="{fork}"><i class="left material-icons">call_split</i>Fork</a></li> <li><a href="" onclick="runstant.shareModal.open(); return false;"><i class="left material-icons">share</i>Share</a></li> <li><a href="" onclick="runstant.detailModal.open(); return false;"><i class="left material-icons">settings</i>Settings</a></li> </ul> </div> </nav>', 'header, [riot-tag="header"]{ display: block } header nav, [riot-tag="header"] nav{ padding: 0px 20px; } header .brand-logo .lighter, [riot-tag="header"] .brand-logo .lighter{ font-weight: 200; } header .side-nav i.left, [riot-tag="header"] .side-nav i.left{ line-height: 64px; }', function(opts) {
    var self = this;
...
<!-- シェアモーダル-->
riot.tag('modal-share', '<div class="modal-content"> <h4>Share</h4> <div class="row"> <div class="col s12"> <div class="row"> <div class="col s8"> <div class="row"> <div class="input-field col s12"> <input name="_shorturl" value="getting..." type="text" onclick="this.select()"> <label>Short URL</label> </div> <div class="input-field col s12"> <input name="_embedcode" value="getting..." type="text" onclick="this.select()"> <label>Embed Code</label> </div> </div> </div> <div class="col s4 center"><img riot-src="https://chart.googleapis.com/chart?chs=128x128&amp;cht=qr&amp;chl={shortURL}"></div> </div> <div class="row"> <h5>Social</h5> <div class="input-field col s12"> <button data-name="twitter" onclick="{share}" class="waves-effect waves-light btn blue lighten-2">Twitter</button> <button data-name="facebook" onclick="{share}" class="waves-effect waves-light btn blue darken-1"> Facebook</button> <button data-name="google" onclick="{share}" class="waves-effect waves-light btn red darken-1"> Google+</button> <button data-name="pocket" onclick="{share}" class="waves-effect waves-light btn pink lighten-1"> Pocket</button> <button data-name="hatebu" onclick="{share}" class="waves-effect waves-light btn blue darken-2"> Hatebu</button> </div> </div> <div class="row"> <h5>Other</h5> <div class="input-field col s12"><a onclick="{fullscreen}" class="waves-effect waves-light btn green lighten-1">Fullscreen</a> <a id="btn-download" onclick="{download}" class="waves-effect waves-light btn amber darken-1">Download</a> <a id="btn-download-zip" onclick="{downloadZip}" class="waves-effect waves-light btn red lighten-1">Download Zip</a> <a id="btn-download-runstant" onclick="{downloadRunstant}" class="waves-effect waves-light btn red lighten-2">Download Runstant</a></div> </div> </div> </div> </div>', 'modal-share { max-height: 85% !important; }', 'id="modal-share" class="modal bottom-sheet"', function(opts) {
    var self = this;
    this.init = function() {
