...
riot.tag('console', '<div class="inner z-depth-2"> <h3>console</h3> </div>', 'console { }', function(opts) {
...
riot.tag('preview', '<div class="inner z-depth-2"> <h3>preview</h3> </div>', 'preview { }', function(opts) {
    this.root.style.width = opts.width;
    this.root.style.height = opts.height;
    this.root.style.float = opts.float;
