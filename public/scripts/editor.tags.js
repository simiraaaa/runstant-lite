...
riot.tag('app', '<header></header> <div class="main"> <editor></editor> <preview></preview> <console></console> </div> <footer></footer>', '.main { position: absolute; width: 100%; height: calc(100% - 64px); overflow: hidden; }', function(opts) {
    this.on('mount', function() {
    });
  
});

riot.tag('console', '<div class="inner z-depth-2"> <h3>console</h3> </div>', 'console { display: block; float: left; width: 40%; height : 40%; padding: 10px; }', function(opts) {

});

riot.tag('editor', '<div class="inner z-depth-4"> <div class="header"> <ul class="tabs"> <li id="tab-html" class="tab col s3"><a data-type="html" href="#editor-html"><span class="type">html</span><span class="lang">(html)</span></a></li> <li id="tab-style" class="tab col s3"><a data-type="style" href="#editor-style"><span class="type">style</span><span class="lang">(css)</span></a></li> <li id="tab-script" class="tab col s3"><a data-type="script" href="#editor-script"><span class="type">script</span><span class="lang">(javascript)</span></a></li> </ul> </div> <div class="content"> <div id="editor"></div> </div> </div>', 'editor { display: block; float: right; width: 60%; height : 100%; padding: 10px; } .inner { border: 1px solid #ccc; width: 100%; height: 100%; } .header { margin-bottom: 1px; } .content { width: 100%; height: calc(100% - 48px); } #editor { width: 100%; height: 100%; }', function(opts) {
    this.on('mount', function() {
...
riot.tag('preview', '<div class="inner z-depth-2"> <h3>preview</h3> </div>', 'preview { display: block; float: left; width: 40%; height : 60%; padding: 10px; }', function(opts) {
