...
riot.tag('app', '<header></header> <editor></editor> <preview></preview> <console></console> <footer></footer>', '.preview { background: #ccf; position: fixed; left: 0px; height: 100%; } .editor { background: #fcc; position: fixed; right: 0px; height: 100%; height : -webkit-calc(100% - 64px) ; height : calc(100% - 64px) ; }', function(opts) {
    this.on('mount', function() {
    });
  
});

riot.tag('console', '<div class="inner z-depth-4"> <h3>console</h3> </div>', 'console { left: 3px; bottom: 0px; width: 40%; height : calc(40% - 64px) ; position: absolute; padding: 10px; }', function(opts) {
...
riot.tag('preview', '<div class="inner z-depth-4"> <h3>preview</h3> </div>', 'preview { left: 3px; width: 40%; height: 60%; height : calc(60% - 64px) ; position: absolute; padding: 10px; }', function(opts) {
