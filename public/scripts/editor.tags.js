...
riot.tag('console', '<div class="inner z-depth-2"> <div class="header blue-grey darken-3 white-text"><span class="title">console</span></div> </div>', 'console { } console .header { padding: 2px 5px; } console .header .title { font-size: 1.5rem; }', function(opts) {
...
riot.tag('preview', '<div class="inner z-depth-2"> <div class="header blue-grey darken-3 white-text"><span class="title">preview</span></div> </div>', 'preview { } preview .header { padding: 2px 5px; } preview .header .title { font-size: 1.5rem; }', function(opts) {
    this.root.style.width = opts.width;
    this.root.style.height = opts.height;
    this.root.style.float = opts.float;
